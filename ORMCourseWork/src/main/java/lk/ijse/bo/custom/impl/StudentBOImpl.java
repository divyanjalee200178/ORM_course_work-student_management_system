...
public class StudentBOImpl implements StudentBO {
   ...
   StudentDAO studentDAO = (StudentDAO) DAOFactory.getDaoFactory().getDAO(DAOFactory.DAOTypes.STUDENT);
    ...
    public boolean save(StudentDTO studentDTO) {
        return studentDAO.save(new Student(studentDTO.getId(),studentDTO.getName(),studentDTO.getAddress(),studentDTO.getTel(),studentDTO.getEmail()));
    }


    @Override
    public boolean update(StudentDTO studentDTO) {
        return studentDAO.update( new Student(studentDTO.getId(),studentDTO.getName(),studentDTO.getAddress(),studentDTO.getTel(),studentDTO.getEmail()));
    }

    @Override
    public boolean delete(StudentDTO studentDTO) {
        return studentDAO.delete(new Student(studentDTO.getId(),studentDTO.getName(),studentDTO.getAddress(),studentDTO.getTel(),studentDTO.getEmail()));
    }
    @Override
